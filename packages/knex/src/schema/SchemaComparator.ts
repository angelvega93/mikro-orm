...
export class SchemaComparator {
  ...
  compare(fromSchema: DatabaseSchema, toSchema: DatabaseSchema): SchemaDifference {
    const diff: SchemaDifference = { newTables: {}, removedTables: {}, changedTables: {}, orphanedForeignKeys: [], fromSchema };
    const foreignKeysToTable: Dictionary<ForeignKey[]> = {};

    // TODO
    // for (toSchema.getNamespaces() as namespace) {
    ...
    // }
    //
    // for (fromSchema.getNamespaces() as namespace) {
